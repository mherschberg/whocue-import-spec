...
- **Questions or problems** with the import contract (schema, examples, or
  instructions) may be raised through GitHub Issues.
- **Security-sensitive reports**: please follow [`SECURITY.md`](SECURITY.md) and
  do not open a public issue.

Use of the files in this repository is governed by [`LICENSE`](LICENSE).
